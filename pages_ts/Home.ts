...
export class Home{
	...
	categories: Locator;
	books: Locator;
	books_verification: Locator;
	computers: Locator;
	computers_verification: Locator;
	electronics: Locator; 
	electronics_verification: Locator; 
	apparel_shoes: Locator; 
	apparel_verification: Locator;
	digital_downloads: Locator; 
	digitaldwnld_verification: Locator;
	jewelry: Locator;
	jewelry_verification: Locator;
	gift_cards: Locator;
	giftcards_verification: Locator;
