...
export class Checkout{
	...
	zipcode: Locator;
	phonenumber: Locator;
	continue_billing: Locator;
	shipping_address: Locator;
	continue_shipping: Locator;
	shipping_method1: Locator;
	shipping_method2: Locator;
	shipping_method3: Locator;
	continue_shipmethod: Locator;
	payment_method1: Locator;
	payment_method2: Locator;
	payment_method3: Locator;
	payment_method4: Locator;
	continue_paymethod: Locator;
	payment_info_cod: Locator;
	continue_paymentinfo: Locator;
	sub_total: Locator;
	shipping_cost: Locator;
	add_fee: Locator;
	tax: Locator;
	total: Locator;
	confirm: Locator;
	order_successmsg: Locator;
	orderID: Locator;
	continue_ordersucess: Locator;
	homepage_verification: Locator;
	logout: Locator;
	login: Locator;
	...
	async _billingAddress(country: string, state: string, city: string, address1: string, zipcode:number, phonenumber: number)
	{
